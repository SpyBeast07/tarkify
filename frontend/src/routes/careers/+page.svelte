<script lang="ts">
  ...
  async function handleSubmit(e: SubmitEvent) {
    ...
    try {
      ...
      status = 'success';
      toastState?.addToast('Application submitted successfully! We will be in touch soon.', 'success');
      resetForm();
    } catch (err) {
      status = 'error';
        ...
        <div class="careers-form-card">
          {#if status === 'success'}
            ...
            >
              ...
              <p class="opacity-70">Your application has been received. We will be in touch soon.</p>
              <button
