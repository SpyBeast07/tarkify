<script lang="ts">
  ...
  async function handleSubmit(e: SubmitEvent) {
    ...
    try {
      ...
      status = 'success';
      toastState?.addToast('Message sent successfully! We will respond within 24 hours.', 'success');
      resetForm();
    } catch (err) {
      status = 'error';
      ...
      >
        {#if status === 'success'}
          ...
          >
            ...
            <p class="opacity-70">Thank you for reaching out. We will get back to you within 24 hours.</p>
            <button
              class="btn btn-submit submit-full mt-6"
              onclick={() => { status = 'idle'; resetForm(); }}
            >
          ...
          <form onsubmit={handleSubmit} novalidate>
            ...
            <div class="form-group">
              ...
              <div class="input-with-icon">
                ...
                <select id="service" name="service" value={formData.service} onchange={handleChange} disabled={status === 'submitting'}>
                  <option value="DevBeast">DevBeast Control Plane</option>
                  <option value="Legal Redline">Legal Redline AI (Coming Soon)</option>
                  <option value="Integrate Business Operating System">Integrate Business Operating System (Coming Soon)</option>
            ...
            <button type="submit" class="btn btn-submit submit-full" disabled={status === 'submitting'}>
